            ...
            <div className="abs-center">
                <form className="border p-3 form" onSubmit={handleSave}>
                    ...
                    <select 
                        ...
                        onChange={ handleInputChange }
                    >
                    <option value="Cliente NO desea el servicio ">Cliente NO desea el servicio </option>
                    <option value="POS">POS</option>
                    <option value="Cliente desea Suspender el servicio Temporalmente">Cliente desea Suspender el servicio Temporalmente</option>
                    </select>
